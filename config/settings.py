"""
Settings for political-positions
"""
...
INSTALLED_APPS = [
    'political-positions.inputs',
    'political-positions.formatters',
    'political-positions.tasks',
    'political-positions.workflows'
]